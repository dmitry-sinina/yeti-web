...
RUN service postgresql start&& ./aux/yeti-db --config config/database.yml.distr --sql-dir sql --yes init
RUN service postgresql start&& ./aux/yeti-db --config config/database.yml.distr --sql-dir sql --yes --cdr init 
RUN service postgresql start&& ./aux/yeti-db --config config/database.yml.distr --sql-dir sql --yes apply_all
RUN service postgresql start&& ./aux/yeti-db --config config/database.yml.distr --sql-dir sql --yes --cdr apply_all
